...
export function Router() {
  ...
  return (
    <div>
        ...
        <Route path={ROUTES.admin} element={<ProtectedRoute loading={loading} error={error}>{user?.uid && !loading?<Admin/>:<Navigate to={ROUTES.login_admin} replace/>}</ProtectedRoute>}/>
